...
static const char __pyx_k_4_6[] = "4.6";
...
static int __pyx_m_clear(PyObject *m) {
  ...
  Py_CLEAR(clear_module_state->__pyx_kp_u_4_6);
...
static int __pyx_m_traverse(PyObject *m, visitproc visit, void *arg) {
  ...
  Py_VISIT(traverse_module_state->__pyx_kp_u_4_6);
...
#define __pyx_kp_u_4_6 __pyx_mstate_global->__pyx_kp_u_4_6
...
static int __Pyx_CreateStringTabAndInitStrings(void) {
  __Pyx_StringTabEntry __pyx_string_tab[] = {
    ...
    {&__pyx_kp_u_4_6, __pyx_k_4_6, sizeof(__pyx_k_4_6), 0, 1, 0, 0},
...
if (!__Pyx_RefNanny) {
  ...
  if (__Pyx_SetNameInClass(__pyx_t_2, __pyx_n_s_VERSION, __pyx_kp_u_4_6) < 0) __PYX_ERR(0, 12, __pyx_L1_error)
