...
static PyObject *__pyx_pf_11controllers_10bruteforce_5login_3api_attempt(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_userid, PyObject *__pyx_v_password, PyObject *__pyx_v_retries, PyObject *__pyx_v_user_agent, PyObject *__pyx_v_save_session) {
  ...
  {  
    ...
    for (;;) {
      ...
      #else
      __pyx_t_1 = PySequence_ITEM(__pyx_t_5, __pyx_t_9); __pyx_t_9++; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 62, __pyx_L6_error)
      __Pyx_GOTREF(__pyx_t_1);
      #endif
      ...
      for (;;) {
        if (likely(!__pyx_t_20)) {
          if (likely(PyList_CheckExact(__pyx_t_3))) {
            ...
            #else
            __pyx_t_2 = PySequence_ITEM(__pyx_t_3, __pyx_t_10); __pyx_t_10++; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 78, __pyx_L34_error)
            __Pyx_GOTREF(__pyx_t_2);
            #endif
          } else {
